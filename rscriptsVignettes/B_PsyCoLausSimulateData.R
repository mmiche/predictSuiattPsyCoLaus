...
# BEWARE: Only if the below code (lines 14-40) is executed without any changes, the simulated dataset will be superficially very similar to the original dataset. Especially will the outcome be identically distributed (4002 non-cases, 48 cases).
...
# # Compare:
# # --------------------------------------------------------
# # Original dataset output for logistic regression analysis
# # --------------------------------------------------------
